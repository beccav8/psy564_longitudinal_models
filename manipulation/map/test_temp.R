...
# ---- declare-globals ----------------------------------------------
pathFileBL       <- file.path("./data/unshared/raw/map/2016/dataset_484_basic_2016-09-09.csv")
pathFileLong     <- file.path("./data/unshared/raw/map//2016/dataset_484_long_2016-09-09.csv")
pathBaselineDate <- file.path("./data/unshared/raw/map/2016/baseline-date-2015-11.csv")
# 
