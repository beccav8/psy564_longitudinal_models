...
read_chunk("./sandbox/obas/exposition-1-obas/mmse-sex-obas.R") 
```
...
```{r graph-mmse, echo=FALSE, message=C_message, warning=C_warning}
```
...
```{r graph-PA_mmse, echo=FALSE, message=C_message, warning=C_warning}
```

# **Between Person PA and MMSE**

```{r graph-PAbp_mmse, echo=FALSE, message=C_message, warning=C_warning}
```

# **Within Person PA and MMSE**

```{r graph-PAwp_mmse, echo=FALSE, message=C_message, warning=C_warning}
```
