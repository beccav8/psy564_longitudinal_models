...
#   by_y = round(top_y/10,0),
  ...
  g11 <- basic_line(d, variable_name, "age_at_visit", "purple", line_alpha, line_size, T)
  g12 <- basic_line(d, predicted, "age_at_visit", "purple", line_alpha, line_size, T)
